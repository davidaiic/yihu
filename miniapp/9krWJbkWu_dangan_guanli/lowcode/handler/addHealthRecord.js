...
_opts => {
  ...
  const newVersion = `v${this.$WEAPPS_COMP.dataset.state.healthRecords.length + 1}.0`;
  this.$WEAPPS_COMP.dataset.state.healthRecords = [...$comp.dataset.state.healthRecords, {
    "version": newVersion,
