...
_opts => {
  ...
  this.$WEAPPS_COMP.dataset.state.article.isLiked = !this.$WEAPPS_COMP.dataset.state.article.isLiked;
  this.$WEAPPS_COMP.dataset.state.article.likes += this.$WEAPPS_COMP.dataset.state.article.isLiked ? 1 : -1;
}
)