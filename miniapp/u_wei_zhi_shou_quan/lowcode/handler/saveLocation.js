...
_opts => {
  ...
  const newLocation = {
    "id": Date.now(),
    "name": params.name || "新位置",
    "address": this.$WEAPPS_COMP.dataset.state.currentLocation.address,
    "isDefault": false,
    "icon": "td:location"
  };
  this.$WEAPPS_COMP.dataset.state.savedLocations = [...$comp.dataset.state.savedLocations, newLocation];
