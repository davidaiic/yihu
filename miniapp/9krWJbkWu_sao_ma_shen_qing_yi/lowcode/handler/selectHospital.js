...
_opts => {
  ...
  this.$WEAPPS_COMP.dataset.state.selectedHospital = params.hospital;
  this.$WEAPPS_COMP.dataset.state.selectedWard = null;
  this.$WEAPPS_COMP.dataset.state.selectedRoom = null;
}
)