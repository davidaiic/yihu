...
_opts => {
  ...
  this.$WEAPPS_COMP.dataset.state.selectedMethod = "byDistance";
  
  //console.log("选择按名字查找医院");

  this.$WEAPPS_COMP.__internal__?.$w?.utils.navigateTo({ pageId:'u_fu_jin_de_yi_yuan',

    params: {       // ← 注意这里用 params 而不是 query
      backpageId:'u_zhu_yuan_hu_li'
    }
