...
_opts => {
  ...
  const selectedPatient = this.$WEAPPS_COMP.dataset.state.patientList[index];

  this.$WEAPPS_COMP.__internal__?.$w?.app.setState({ current_patient_info : selectedPatient });
